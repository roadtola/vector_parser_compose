...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public Object getTargetByName(String name) {
        Log.d("TAG", "getTargetByName: "  + mVectorState.mVPathRenderer.mVGTargetsMap);
...
//        }
    ...
    public static class VGroup {
        ...
        public @NonNull ArrayList<VectorDrawableCompat.VFullPath> getChildren() {
            if(mChildren.size() == 0) return new ArrayList<>();

            ArrayList<VectorDrawableCompat.VFullPath> res = new ArrayList<>();
            for(int i = 0; i < mChildren.size(); i++){
                res.add((VectorDrawableCompat.VFullPath) mChildren.get(i));
            }
            return res;
        }
        ...
        public void setFill(int fillColor){
            for(int i = 0; i < mChildren.size(); i++){
                VFullPath path = (VFullPath) mChildren.get(i);
                path.mFillColor = fillColor;
            }
        }
